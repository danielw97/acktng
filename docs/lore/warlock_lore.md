...
## I. The Shadow Compacts

The **shadow compacts** that form the Warlock tradition's foundational practice are not contracts in the legal sense — they are **working relationships with entities whose nature is poorly understood** by the practitioners who enter into them. The entities are described in the tradition's documentation using terms that reflect the specific practitioner's cultural framework: some practitioners describe their compact counterparties as spirits, some as embodied principles of entropy and shadow, some as fragments of the Black Sun Shard's anti-light essence that have achieved a kind of autonomous agency outside the Great Pyramid's containment.

The last description — Black Sun Shard fragments — is the one that the tradition itself most consistently avoids, because it implies implications that practitioners prefer not to examine closely. If the compact counterparties are fragments of the Shard's anti-light essence, then the Warlock tradition's power source is the same cosmic threat that the cleric tradition has spent millennia attempting to contain. This would make Warlocks and clerics adversaries at a foundational level rather than simply practitioners of different approaches — and it would make every shadow compact a small piece of the Shard's influence extending beyond its containment.

The tradition's own position is that this analysis is both plausible and incomplete: the entities that anchor shadow compacts may be fragments of the Shard's essence, or they may be something else entirely that has merely taken up residence in the conceptual space the Shard's presence created. The practical distinction matters less than practitioners outside the tradition might assume, because the compact is the anchor of the practice regardless of the entity's ultimate nature.
...
## III. Hex Craft and the Art of Undoing
...
## IV. The Price and Its Management

The tradition's acknowledgment that "every hex carries a price" is one of the few doctrinal claims that appears consistently across all Warlock lineages, regardless of their specific compact structure. The compacts are working relationships, not free power sources; the entities that anchor them receive something from every application of the compact's power, and that something comes from the practitioner.

The nature of the price varies by compact. Some practitioners describe the price as **attention cost** — the compact counterparty's awareness is in some sense present in every hex application, observing the practitioner's situation and accumulating knowledge of their methods and relationships. Some describe it as **resonance debt** — each hex application increases the depth of the compact relationship in ways that make subsequent disengagement progressively more difficult. Some describe it as more concrete extraction: specific memories, emotional states, or physical capacity that the entity withdraws in exchange for the power it provides.

The tradition's methodology for managing the price is essentially harm-reduction focused: understanding the specific nature of one's compact price, monitoring whether the price is being paid at sustainable rates, and maintaining deliberate awareness of whether the compact relationship is evolving in directions that serve the practitioner's own purposes or only the entity's. Warlocks who lose track of this monitoring frequently find that their compact has developed in ways they didn't intend — that the price has shifted from what they understood it to be, or that the entity's requirements have become more demanding as the relationship has deepened.

The Nightblade synthesis creates a specific dimension of this management challenge: a practitioner who has developed both full Assassin-tradition methodology and full Warlock-tradition compact practice is operating with the compact's entity in close proximity to the information-rich operational context that the Assassin practice requires. Whether compact counterparties that observe enough operational detail become a security risk is a question that senior Nightblade practitioners tend to address carefully.
