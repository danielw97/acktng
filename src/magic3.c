...
{
   CHAR_DATA *summoned = player_summon(ch, 100 + ch->class_level[CLASS_SOR] / 4, WATER_ELEMENTAL);
...
{
   CHAR_DATA *summoned = player_summon(ch, 100 + ch->class_level[CLASS_NEC] / 4, SKELETON);
...
{
   CHAR_DATA *summoned = player_summon(ch, 100 + ch->class_level[CLASS_SOR] / 4, EARTH_ELEMENTAL);
...
{
   CHAR_DATA *summoned = player_summon(ch, 100 + ch->class_level[CLASS_SOR] / 4, IRON_GOLEM);
...
{
   CHAR_DATA *summoned = player_summon(ch, 100 + ch->class_level[CLASS_SOR] / 4, DIAMOND_GOLEM);
