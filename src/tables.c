...
const struct lookup_extended_type tab_race_mod[] = {
    ...
    {"miracle heal", RACE_MOD_MIRACLE_HEAL, RACE_MOD_EXTRAORDINARY_HEAL, 1, "Increases your regeneration by 4x"},
    {"extraordinary heal", RACE_MOD_EXTRAORDINARY_HEAL, RACE_MOD_FAST_HEAL, 1, "Increase your regeneration by 3x"},
    ...
    {"strong magic", RACE_MOD_STRONG_MAGIC, RACE_MOD_NONE, 1, "Increases all of your magical damage dealt by 10%"},
    {"magic adept", RACE_MOD_MAGIC_ADEPT, RACE_MOD_STRONG_MAGIC, 3, "Increases all of your magical damage dealt by 20%"},
    {"magic genius", RACE_MOD_MAGIC_GENIUS, RACE_MOD_MAGIC_ADEPT, 5, "Increases all of your magical damage dealt by 30%"},
    {"weak magic", RACE_MOD_WEAK_MAGIC, RACE_MOD_NONE, -1, "Reduces all magical damage you deal by 25%"},
    ...
    {"resist magic", RACE_MOD_RESIST_MAGIC, RACE_MOD_NONE, 1, "Reduces magical damage you take by 10%"},
    {"thwart magic", RACE_MOD_THWART_MAGIC, RACE_MOD_RESIST_MAGIC, 2, "Reduces magical damage you take by 20%"},
    {"magic foil", RACE_MOD_MAGIC_FOIL, RACE_MOD_THWART_MAGIC, 3, "Reduces magical damage you take by 30%"},
    ...
    {"tough skin", RACE_MOD_TOUGH_SKIN, RACE_MOD_NONE, 1, "Reduces physical damage you take by 10%"},
    {"stone skin", RACE_MOD_STONE_SKIN, RACE_MOD_TOUGH_SKIN, 2, "Reduces physical damage you take by 20%"},
    {"iron skin", RACE_MOD_IRON_SKIN, RACE_MOD_IRON_SKIN, 3, "Reduces physical damage you take by 30%"},
    {"strong", RACE_MOD_STRONG, RACE_MOD_NONE, 1, "Increases physical damage you deal by 10%"},
    {"hercules", RACE_MOD_HERCULES, RACE_MOD_STRONG, 3, "Increases physical damage you deal by 20%"},
    {"goliath", RACE_MOD_GOLIATH, RACE_MOD_HERCULES, 5, "Increases physical damage you deal by 30%"},
    {NULL, -1, 0, -1, NULL}};
