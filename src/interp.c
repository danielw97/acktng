...
const struct cmd_type cmd_table[] = {
    ...
    CMD("ashfall strike", do_ashfall_strike, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("harbor dust", do_harbor_dust, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    ...
    CMD("checkpoint break", do_headbutt, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("kick", do_kick, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("road sweep", do_knee, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    ...
    CMD("dunmar's call", do_warcry, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    ...
    CMD("interior discipline", do_mindoverbody, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    ...
    /* Cipher skills */
    CMD_NINJA("reach silence", do_garrote, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("dissolution protocol", do_feign_death, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("gap transit", do_shadow_step, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("asset flag", do_mark_target, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("gap hold", do_conceal, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("seam snare", do_set_trap, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    ...
    CMD("seven shade hold", do_fortify, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("charter challenge", do_taunt, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    ...
    CMD("roll with blow", do_roll_with_blow, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION,
        C_SHOW_SKILL),
    CMD("applied understanding", do_pressure_point, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
        C_SHOW_SKILL),
    CMD("feint", do_feint, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    CMD("cistern discipline", do_conditioning, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL),
    /* Sentinel skills */
