...
const struct cmd_type cmd_table[] = {
    ...
    {"knee", do_knee, POS_FIGHTING, 0, LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_SKILL},
    {"leadership", do_leadership, POS_FIGHTING, 0, LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_SKILL},
    {"morale", do_morale, POS_FIGHTING, 0, LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_SKILL},
    {"murde", do_murde, POS_FIGHTING, 5, LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_NEVER},
    {"murder", do_murder, POS_FIGHTING, 5, LOG_ALWAYS,
     C_TYPE_ACTION, C_SHOW_ALWAYS},
    {"palmstrike", do_palmstrike, POS_FIGHTING, 0, LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_SKILL},
    {"poison:arsenic", do_poison_arsenic, POS_FIGHTING, 0, LOG_NORMAL,
     C_TYPE_ACTION, C_SHOW_SKILL},
...
void interpret(CHAR_DATA *ch, char *argument)
{
    ...
    */
   if (!IS_NPC(ch) && ch->stance > 0 && IS_SET(stance_app[ch->stance].specials, STANCE_NINJA) && ((str_prefix(command, "kill")) && (str_prefix(command, "murder")) && (str_prefix(command, "backstab")) && (str_prefix(command, "bs")) && (str_prefix(command, "whisper")) && (str_prefix(command, "stake")) && (str_prefix(command, "steal"))))
