...
static const char *invasion_boss_trash_talk_for_profile(int prof_idx)
{
   ...
   static const char *const trash_talk_by_profile[NUM_BOSSES][15] = {
       {"I am Typhon, sire of monsters; your bones are my hatchery.",
        "Zeus buried me under Etna's roots with his thunder. You have neither mountain nor lightning.",
        ...
        "I sired the Hydra's hunger; your city will feed it in spirit.",
       ...
       {"The World-Serpent's blood remembers you, little shore-crawlers.",
        ...
        "The deep has no mercy, and neither do I.", "Your champions thrash like fish on a deck.",
       ...
       {"Ravens have already carried your names to the other side.",
        "I do not bring death. I announce what was always coming.",
        "The crow on the battlefield has already heard your last confession.",
        "Fate is not cruel. It merely does not ask for your opinion.",
        "I washed your armor before this battle. Did you wonder what washed it?",
        "I stood over the Dagda himself and spoke his end. Stand still for yours.",
        "I am the washer at the ford, and the armor I clean is always yours.",
        "Every war ends. Only the prophecy about it lasts, and I wrote yours.",
        "Your allies look pale. Perhaps I visited them first.",
        "I have three faces. Only one is merciful, and none of them are here.",
        "Cuchulainn himself could not escape my prophecy. You are not Cuchulainn.",
        "I do not haunt battlefields. Battlefields gather around me.",
        "Your armor shines. That draws my eye, and my eye marks the dead.",
        "A crow sat on your gate this morning. Did no one warn you what that meant?",
        "I am the Morrigan. You were already dead when I arrived."},
       {"I murdered a god and scattered the pieces across the Nile. Your city is simpler work.",
        "Osiris tried to contain my nature. Look how that ended for him.",
        "The desert does not apologize for what it buries. Neither do I.",
        "I was protector of the sun-barque before I became its greatest threat. Old habits linger.",
        "Every sandstorm that buries a city whispers my name at its heart.",
        "Horus and I fought for ages. You have less patience than Horus.",
        "The desert does not grow. It claims. I am the claiming.",
        "I split Osiris into fourteen pieces. How many shall I make of you?",
        "Ra needed me to defend the sun from Apep. Apep sends his regards.",
        "Chaos is not destruction. It is the truth that existed before order painted over it.",
        "The red sands remember every traveler they swallowed. So do I.",
        "You call me usurper. Osiris called me brother. Both misjudge what I am.",
        "My domain is everything civilization fears: storm, desert, and the end of order.",
        "I have fought gods to a standstill for generations. You barely merit counting.",
        "The Nile runs red in my wake. Your blood is a lesser river."},
       ...
       {"I am Surtr's edge at the end of ages.",
        ...
        "Even gods feared this fire at Ragnarok.", "Your banners will be torches by sunset.",
        ...
        "I do not chase prey; the fire drives it to me.", "Your healers mend flesh, not ash.",
       ...
       {"I am the maw beneath the waves and I am still hungry.",
        ...
        "Wind obeys me, and water kneels.", "Your battle line is already a whirlpool.",
        "I swallow prayers and belch storms.", "Do not scream; the sea mutes all confessions.",
        "Every splash is another promise you cannot keep.",
        "I have drowned kings in calmer waters than these.",
        "Breathe now while you still own the air.", "Your boots are heavy. Good. Sink faster.",
        "The deep keeps what it takes.", "Tides turn. So do fortunes. Yours just did.",
       ...
       {"I gnawed Yggdrasil's roots; your walls are softer.",
        ...
        "Your flesh will rot before it cools.", "I have chewed through oaths, bones, and worlds.",
        ...
        "The dead envy the living until I arrive.", "You clutch talismans; I clutch throats.",
        "I do not hoard gold. I hoard endings.",
        "Your champions will decorate Hel's shore by dawn.", "One bite for marrow, one for memory.",
        "Rot is inevitable. I simply hurry it.", "Yggdrasil endured me. You will not."},
       {"Hear my song and ride with me into your own grave.", "The Wild Hunt never misses debtors.",
       ...
       {"The scales of Ma'at tip, and you are found wanting.",
        ...
        "I am the final mouth after final judgment.", "The righteous pass by me. You do not.",
        "Struggle if you must; it seasons the heart.", "Sentence delivered: consumed."},
       {"Order is a fragile sun. I am the shadow across it.",
        ...
        "I am the knot in creation's throat.", "When I hiss, empires forget their own names.",
        "Stand in line if you want; I break lines for sport.",
        "I am Apep. Night itself marches under my scales."},
       {"Bronze does not panic. Bronze advances.", "I was forged by a god-smith; you were not.",
        "Hear my stride—Crete remembers this sound as judgment.",
        "Your blades ring against me like chimes in a storm.",
        "Molten ichor is the only blood I need.", "I patrol, I punish, I persist.",
        "Rust is your prayer; steel is mine.", "You are flesh confronting engineering.",
