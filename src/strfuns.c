...
char *learnt_name(int sn, int learnt)
{
   /*
   ...
   if (!skill_table[sn].can_learn)
      return "Learnt";

   if (learnt < LEVEL_ONE)
      return "Zero";
   else if (learnt < LEVEL_TWO)
      return "One";
   else if (learnt < LEVEL_THREE)
      return "Two";
   else if (learnt < LEVEL_FOUR)
      return "Three";
   else if (learnt < LEVEL_FIVE)
      return "Four";
