...
const struct stance_app_type stance_app[MAX_STANCE] = {
    {"Adventurer", 0, 0, 0, 0, 0, 0, 0,
     MORTAL, -1, -1, -1, -1},
    /* Mortal stances */
    {"Mage", 20, -3, -3, 0, 0, 2, STANCE_EITHER_CLASS | STANCE_MULTI_CAST | STANCE_NO_HIT, 
    ...
    {"Sorcerer", 5, -3, -3, 0, -2, 5, STANCE_MULTI_CAST | STANCE_NO_HIT,
     REMORT, CLASS_SOR, 1, -1, -1, -1},
    {"Wizard", 5, -3, -3, 0, -2, 5, STANCE_DUAL_CAST | STANCE_NO_HIT,
    ...
    {"Necromancer", 5, -3, -3, 0, 0, 5, STANCE_MULTI_CAST | STANCE_NO_HIT,
     REMORT, CLASS_NEC, 1, -1, -1, -1},
    {"Egomancer", 5, -3, -3, 0, 0, 5, STANCE_DUAL_CAST | STANCE_NO_HIT,
    ...
    /* Adept Stances */
    {"Magi", 10, -5, -5, 0, 0, 0, STANCE_EITHER_CLASS | STANCE_MULTI_CAST | STANCE_DUAL_CAST,
