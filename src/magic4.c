                                            ...
                                            int element)
{
   ...
   if (obj == NULL)
   {
      int base = ch->class_level[MAX_CLASS + CLASS_WIZ];

      if (ch->class_level[MAX_CLASS + CLASS_SOR] > base)
         base = ch->class_level[MAX_CLASS + CLASS_SOR];
...
bool spell_fireblast(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   if (obj == NULL)
   {
      ...
      if (ch->class_level[MAX_CLASS + CLASS_NEC] > base)
         base = ch->class_level[MAX_CLASS + CLASS_NEC];
...
bool spell_shockstorm(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   if (obj == NULL)
   {
      ...
      if (ch->class_level[MAX_CLASS + CLASS_SOR] > base)
         base = ch->class_level[MAX_CLASS + CLASS_SOR];
      if (ch->class_level[MAX_CLASS + CLASS_EGO] > base)
         base = ch->class_level[MAX_CLASS + CLASS_EGO];
      if (ch->class_level[MAX_CLASS + CLASS_NEC] > base)
         base = ch->class_level[MAX_CLASS + CLASS_NEC];
...
bool spell_holy_wrath(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   if (obj == NULL)
   {
      int base = ch->class_level[MAX_CLASS + CLASS_PRI];
      if (ch->class_level[MAX_CLASS + CLASS_PAL] > base)
         base = ch->class_level[MAX_CLASS + CLASS_PAL];
...
bool spell_wraith_touch(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   drain_mod = ch->class_level[MAX_CLASS + CLASS_NEC] * dam / 130;
...
bool spell_thought_vise(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   if (obj == NULL)
   {
      int base = ch->class_level[MAX_CLASS + CLASS_EGO];
...
bool spell_sonic_blast(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   AFFECT_DATA af;
   int dam;
   dam = 150 + dice(ch->class_level[MAX_CLASS + CLASS_EGO]/2, 20);
...
bool spell_regen(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   int base_heal = spell_regen_base_heal(ch->class_level[CLASS_MAG], ch->class_level[MAX_CLASS + CLASS_SOR], ch->class_level[MAX_CLASS + CLASS_WIZ], get_spellpower(ch));
...
bool spell_magical_supremacy(int sn, int level, CHAR_DATA *ch, void *vo, OBJ_DATA *obj)
{
   ...
   if (ch->class_level[MAX_CLASS + CLASS_EGO] > 0)
      buff = ch->class_level[MAX_CLASS + CLASS_EGO] * 1.5;
   else if (ch->class_level[MAX_CLASS + CLASS_WIZ] > 0)
      buff = ch->class_level[MAX_CLASS + CLASS_WIZ] * 1.5;
   else
      buff = 20;
