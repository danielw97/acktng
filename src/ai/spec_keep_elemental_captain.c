...
static void do_fire_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@R$n drives a pillar of searing flame into $N — the air ignites\r\n"
...
static void do_air_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@C$n calls down a lance of pure lightning onto $N — every hair\r\n"
...
static void do_water_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@B$n releases a crushing torrent of icy water at $N — the cold\r\n"
...
static void do_earth_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@g$n slams both fists down and the earth erupts beneath $N —\r\n"
...
bool spec_keep_elemental_captain(CHAR_DATA *ch)
{
    ...
    case 1:
        ch->spec_behavior2 = 0;
        sprintf(buf,
            "@@R$n's gauntlets begin to glow a deep crimson — the air shimmers\r\n"
    ...
    case 2:
        sprintf(buf,
            "@@R$n's armour blazes red-hot!  The fire is almost ready —\r\n"
    ...
    case 3:
        ...
        {
            sprintf(buf,
                "@@B$n's flames gutter and die, snuffed out by the water you\r\n"
    ...
    case 4:
        ch->spec_behavior2 = 0;
        sprintf(buf,
            "@@C$n raises $s sword and wind screams around the blade —\r\n"
    ...
    case 5:
        sprintf(buf,
            "@@C$n's sword hums with building lightning!  Counter with\r\n"
    ...
    case 6:
        ...
        {
            sprintf(buf,
                "@@g$n's lightning arcs harmlessly into the earth as you ground\r\n"
    ...
    case 7:
        ch->spec_behavior2 = 0;
        sprintf(buf,
            "@@B$n draws moisture from the air — frost crawls across $s\r\n"
    ...
    case 8:
        sprintf(buf,
            "@@B$n's breath fogs white; ice forms at $s feet!  Strike with\r\n"
    ...
    case 9:
        ...
        {
            sprintf(buf,
                "@@RYour fire melts $n's icy charge in a burst of steam!\r\n"
    ...
    case 10:
        ch->spec_behavior2 = 0;
        sprintf(buf,
            "@@g$n plants $s feet wide and the floor trembles — stone dust\r\n"
    ...
    case 11:
        sprintf(buf,
            "@@g$n's fists glow with the weight of mountains!  Scatter the\r\n"
    ...
    case 0:
        ...
        {
            sprintf(buf,
                "@@CThe wind you sent tears through $n's earthen charge!\r\n"
