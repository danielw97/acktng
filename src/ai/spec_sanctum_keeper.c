...
static void keeper_inc_absorb(CHAR_DATA *ch)
{
    ...
    if (count < 3)
        ch->spec_behavior2 = (ch->spec_behavior2 & ~KEEPER_ABSORB_MASK)
                            | ((count + 1) << KEEPER_ABSORB_SHIFT);
}
...
static void do_arcane_cascade(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@P$n's runes flare in unison — a cascade of raw arcane force\r\n"
    ...
    calculate_damage(ch, ch->fighting, dam, gsn_holystrike,
                     ELEMENT_MENTAL | ELEMENT_HOLY, TRUE);
}
...
static void do_sanctum_collapse(CHAR_DATA *ch, int absorptions)
{
    ...
    {
        sprintf(buf,
            "@@a$n's runes sputter and dim — every overload has left $m\r\n"
    ...
    {
        sprintf(buf,
            "@@R$n howls as the sanctum's full power channels through $s runes!\r\n"
    ...
    {
        sprintf(buf,
            "@@R$n releases twin waves of stored runic energy — the sanctum\r\n"
            "shakes violently as arcane force washes over everyone!@@N");
    }
    else
    {
        sprintf(buf,
            "@@e$n gathers the last of $s absorbed energy and hurls it\r\n"
    ...
    for (vch = ch->in_room->first_person; vch != NULL; vch = vch_next)
    {
        ...
        calculate_damage(ch, vch, dam, gsn_holystrike,
                         ELEMENT_HOLY | ELEMENT_SHADOW | ELEMENT_MENTAL, TRUE);
    }
}
...
bool spec_sanctum_keeper(CHAR_DATA *ch)
{
    ...
    case 1:
        ...
        sprintf(buf,
            "@@P$n's runes begin to writhe and shift — cracks of unstable\r\n"
    ...
    case 2:
        sprintf(buf,
            "@@P$n's runes pulse wildly, each glyph hungry for energy!\r\n"
    ...
    case 3:
        ...
        {
            sprintf(buf,
                "@@W$n's runes OVERLOAD — conflicting energies tear through\r\n"
    ...
    case 4:
        ...
        {
            sprintf(buf,
                "@@a$n traces a rune in the air with one finger, the glyph\r\n"
        ...
        {
            sprintf(buf,
                "@@a$n's runes flicker weakly, their energy spent.  The Keeper\r\n"
    ...
    case 6:
        keeper_clear_elem(ch);
        sprintf(buf,
            "@@P$n's runes flare again — the glyphs spiral faster now,\r\n"
    ...
    case 7:
        sprintf(buf,
            "@@P$n's runes surge with building force — the air crackles!\r\n"
    ...
    case 8:
        ...
        {
            sprintf(buf,
                "@@W$n's runes shatter with a blinding flash!  Too many\r\n"
    ...
    case 9:
        sprintf(buf,
            "@@a$n draws $s robes tighter, fingers tracing protective\r\n"
    ...
    case 11:
        keeper_clear_elem(ch);
        sprintf(buf,
            "@@R$n's runes ignite — every glyph blazes at once, the air\r\n"
    ...
    case 12:
        sprintf(buf,
            "@@R$n's runes reach critical mass — the sanctum itself trembles!\r\n"
    ...
    case 13:
        ...
        {
            sprintf(buf,
                "@@W$n's runes DETONATE inward!  The cascade of conflicting\r\n"
    ...
    case 14:
        ...
        {
            sprintf(buf,
                "@@R$n begins channeling every absorbed rune toward the sanctum\r\n"
        ...
        {
            sprintf(buf,
                "@@a$n falters, $s runes dim and cracked.  Without any stored\r\n"
