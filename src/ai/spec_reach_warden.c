...
bool spec_reach_warden(CHAR_DATA *ch)
{
   ...
   static char *says[] = {
       ...
       "Every cairn between here and the Seal carries our mark. That is not tradition -- it is "
       "jurisdiction.",
       "Measure's Rest keeps tablets older than Mafdet's harbor chain. We were here first. We "
       "remain.",
