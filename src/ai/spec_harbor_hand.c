...
bool spec_harbor_hand(CHAR_DATA *ch)
{
   static const char *acts[] = {
       ...
       "$n watches the river current for a moment before returning to the crates stacked along the "
       "wharf.",
   ...
   static const char *says[] = {
       ...
       "Levee manifest said three crates of cedar planks. I count two. Dock master's going to love "
       "that.",
       "River traffic is backed up from the southern bends. Something on the road approach, the "
       "boatmen say.",
       "The wharf team works bell to bell with no slack. Nobody complains if the boats keep "
       "moving.",
       "Cargo doesn't move itself. That's what they forget when they're writing the tariff "
       "schedules."};
