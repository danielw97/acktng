...
bool spec_lamplighter(CHAR_DATA *ch)
{
   static const char *acts[] = {
       "$n trims a lamp wick with practiced hands, a small curl of smoke rising as the flame "
       "steadies.",
   ...
   static char *says[] = {
       ...
       "You see a dark corner in this city, report it to the Lantern Registry. I'll have it lit by "
       "Ash Watch.",
