...
bool spec_cinderteeth_caldera_watcher(CHAR_DATA *ch)
{
    ...
    if (ch->spec_behavior2 == 0 && ch->max_hit > 0 &&
        ch->hit * 100 / ch->max_hit < 25)
    {
        ch->spec_behavior2 = 1;
        sprintf(buf,
            "@@R$n's territorial fury erupts — the caldera watcher enters\r\n"
    ...
    case 0:
        if (in_frenzy)
        {
            ...
            sprintf(buf,
                "@@R$n circles with primal speed and hammers $N from an\r\n"
        ...
        {
            sprintf(buf,
                "@@R$n pivots to pace the caldera perimeter, $s heat-shimmer\r\n"
    ...
    case 2:
        {
            int dam = number_range(in_frenzy ? 11000 : 10000,
                                   in_frenzy ? 15000 : 13000);
            sprintf(buf,
                "@@R$n launches a full-weight caldera charge — $s entire body\r\n"
    ...
    case 4:
        {
            ...
            sprintf(buf,
                "@@R$n exhales a blast of superheated air from $s caldera-adapted\r\n"
    ...
    case 6:
        {
            int dam = number_range(9000, 12000);
            sprintf(buf,
                "@@R$n drives $s weight into the coupled caldera floor —\r\n"
