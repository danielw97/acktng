...
bool spec_lay_sister(CHAR_DATA *ch)
{
   ...
   static char *says[] = {
       ...
       "No judgment hidden, no sentence unrecorded. Second Oath. The Temple holds to it even when "
       "the courts do not.",
       "No levy taken that cannot be borne. Third Oath. The hardest to keep, in my experience.",
       "The Temple maintains rolls of the uncounted. Those removed from the ledgers are still "
       "remembered here.",
       "Two bells after midnight are not alarm. They are memorial. The city remembers, even when "
       "it pretends not to."};
