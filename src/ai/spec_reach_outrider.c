...
bool spec_reach_outrider(CHAR_DATA *ch)
{
   ...
   static char *says[] = {
       ...
       "Your manifest shows water-debt outstanding. We can consolidate that. The terms are... "
       "reasonable.",
       "Late at the Seal means penalties at the Strand. Delay is a debt like any other.",
       "Sign today and keep your wagons. Refuse, and we'll collect what's left after weather and "
       "law."};
