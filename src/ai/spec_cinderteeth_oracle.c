...
bool spec_cinderteeth_oracle(CHAR_DATA *ch)
{
   ...
   {
   case 1:
      sprintf(buf, "@@R$n reads the vent's pulse and pronounces — '@@pThe mountain\r\n"
   ...
   case 3:
      sprintf(buf, "@@R$n opens $s arms wide and communes with the Speaking Vent —\r\n"
   ...
   case 5:
   {
      ...
      sprintf(buf, "@@R$n issues a theological verdict — the vent and the stone both\r\n"
   ...
   case 7:
      sprintf(buf, "@@R$n strips $N of false protections before the speaking vent —\r\n"
   ...
   case 9:
   {
      ...
      sprintf(buf, "@@R$n raises both fists and pronounces the mountain's ruling —\r\n"
