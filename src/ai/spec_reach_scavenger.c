...
bool spec_reach_scavenger(CHAR_DATA *ch)
{
   ...
   static char *says[] = {
       ...
       "Salvage law says abandoned structures are fair claim. The Wardens only argue the word "
       "'abandoned'.",
       "Careful with that seal-stone. Cracked, it's gravel. Intact, a scholar pays a season's "
       "wage.",
