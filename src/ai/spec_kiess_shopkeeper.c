...
bool spec_kiess_shopkeeper(CHAR_DATA *ch)
{
   ...
   static char *says[] = {
       "Most of what you need for the frontier is right here. We stock for the road, not the "
       "shelf.",
       "Supply shipment came in yesterday — good selection at the moment. Won't last the week.",
       "The Exchange backs the quality of everything on this counter. Kiess doesn't traffic in "
       "inferior goods.",
       "If you're heading north into the Forest, talk to the cartographer first. Know what you're "
       "walking into.",
       "Roc Road caravans bring good stock from Midgaard. Come back in a few days if I'm short on "
       "something."};
