...
static void do_holy_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@W$n's ward detonates in a blinding column of holy light —\r\n"
...
static void do_shadow_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@D$n's ward collapses inward, releasing a vortex of devouring\r\n"
...
static void do_mental_blast(CHAR_DATA *ch)
{
    ...
    sprintf(buf,
        "@@P$n's ward shatters outward — a psychic shockwave hammers\r\n"
...
static void do_solitude_burst(CHAR_DATA *ch, int unbroken)
{
    ...
    {
        sprintf(buf,
            "@@a$n shudders with frustrated rage, but $s solitude is too\r\n"
    ...
    {
        sprintf(buf,
            "@@R$n howls with the fury of unbroken centuries!  The air itself\r\n"
    ...
    {
        sprintf(buf,
            "@@R$n channels $s remaining fury — twin wards explode outward\r\n"
            "in a devastating wave of arcane destruction!@@N");
    }
    else
    {
        sprintf(buf,
            "@@e$n gathers $s last unbroken ward and hurls it outward —\r\n"
...
bool spec_hermit_archon(CHAR_DATA *ch)
{
    ...
    case 1:
        ...
        sprintf(buf,
            "@@W$n's eyes flare white — a shimmering ward of holy energy\r\n"
    ...
    case 2:
        sprintf(buf,
            "@@W$n's holy ward blazes brighter!  The air hums with purifying\r\n"
    ...
    case 3:
        ...
        {
            sprintf(buf,
                "@@DYour shadow tears through $n's holy ward!  The light gutters\r\n"
    ...
    case 4:
        sprintf(buf,
            "@@a$n mutters bitterly about $s broken solitude, ancient eyes\r\n"
    ...
    case 6:
        archon_clear_elem(ch);
        sprintf(buf,
            "@@D$n draws darkness from the corners of the room — tendrils\r\n"
    ...
    case 7:
        sprintf(buf,
            "@@D$n's shadow ward deepens — the darkness is almost solid!\r\n"
    ...
    case 8:
        ...
        {
            sprintf(buf,
                "@@WYour holy light burns through $n's shadow ward!  The\r\n"
    ...
    case 9:
        sprintf(buf,
            "@@a$n straightens slowly, bones cracking, and fixes you with\r\n"
    ...
    case 11:
        archon_clear_elem(ch);
        sprintf(buf,
            "@@P$n's temples pulse with visible psychic energy — the air\r\n"
    ...
    case 12:
        sprintf(buf,
            "@@P$n's mental ward reaches critical mass — you can feel your\r\n"
    ...
    case 13:
        ...
        {
            sprintf(buf,
                "@@yYour physical blow jars $n's concentration!  The psychic\r\n"
    ...
    case 14:
        ...
        {
            sprintf(buf,
                "@@R$n begins drawing power from $s unbroken wards — the\r\n"
        ...
        {
            sprintf(buf,
                "@@a$n paces in a tight circle, muttering.  Without any intact\r\n"
