...
bool spec_reach_guide(CHAR_DATA *ch)
{
   ...
   static char *says[] = {
      ...
      "We guided before the Keepers carved their first obelisk. The songs remember what stones forget.",
      "I guide anyone who pays. Warden, Outrider, Synod -- the glass does not care about your politics.",
