...
bool spec_vendor(CHAR_DATA *ch)
{
   static const char *calls[] = {
       ...
       "$n gestures at $s table: 'Day-mark stamped, tariff-cleared — everything here paid its "
       "Ledgerhouse due!'",
       "$n calls out, 'Good leather out of the armorer quarter — don't pay shop prices for "
       "off-cuts!'",
       "$n waves at a passing pedestrian: 'Fair price, honest weight, Registry-notated goods, "
       "citizen!'"};
   static char *says[] = {
       "Tariff board raised the western-goods levy again. Prices have to reflect it, nothing "
       "personal.",
       "The Guild Concordat sets minimums, but we independent vendors set our own ceiling. Fair is "
       "fair.",
