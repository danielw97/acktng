...
bool spec_ss_manifest_warden(CHAR_DATA *ch)
{
   static const char *acts[] = {
       "$n checks a manifest slate against a stack of witness sticks, confirming cohort marks one "
       "by one.",
       "$n traces an old Scorch Clause formula with a stylus, then stamps the margin with a gate "
       "sigil.",
   ...
   static char *says[] = {
       "Manifest mismatch means queue delay. Queue delay means heat exposure. Keep your papers "
       "straight.",
       "Westbound returns without unauthorized additions move quickly. Everything else gets "
       "opened.",
       "Your witness cohort mark and your ration ledger must agree. No exceptions at this gate.",
       "Scorch Clause segment liability transfers here. Read your own seal text before arguing "
       "with me.",
