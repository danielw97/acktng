...
bool spec_midgaard_city_guard(CHAR_DATA *ch)
{
   static const char *acts[] = {
      ...
      "$n rests one hand on $s weapon pommel and watches a passing cart with professional attention.",
   ...
   static char *says[] = {
      ...
      "Trouble in the Gloamvault approaches gets escalated to the Warden authority. The Watch handles the street.",
      "Move along if you're not conducting civic business. Loitering in the temple ward draws attention.",
      "Carrying unregistered arcane materials in the northern district is a Compact violation. The warden post is at the checkpoint arch.",
      "Night patrol is heavier near the caravan square. Trade goods attract the wrong kind of interest after Bell Watch."
   };
