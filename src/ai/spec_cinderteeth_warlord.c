...
bool spec_cinderteeth_warlord(CHAR_DATA *ch)
{
    ...
    case 1:
        sprintf(buf,
            "@@r$n slams a fist against $s armour and barks the Ashfang blood-oath —\r\n"
    ...
    case 3:
        {
            ...
            sprintf(buf,
                "@@r$n drives an armored shoulder into $N with bone-cracking force,\r\n"
    ...
    case 5:
        sprintf(buf,
            "@@r$n produces a pitch-blackened offhand blade and drags it across\r\n"
    ...
    case 7:
        sprintf(buf,
            "@@r$n shouts '@@yBreak the line!@@r' and hammers $N with a\r\n"
