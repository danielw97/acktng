...
unit-test-sniff-is-tls: $(OBJDIR)/tests/test_sniff_is_tls.o
	rm -f tests/unit-test-sniff-is-tls
	$(CC) -o tests/unit-test-sniff-is-tls $(OBJDIR)/tests/test_sniff_is_tls.o $(L_FLAGS)
