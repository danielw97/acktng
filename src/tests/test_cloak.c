...
{
   assert(cloak_transcendence_avoids_physical_hit(100, ELE_PHYSICAL, TYPE_HIT, TRUE, 48, 2) ==
          TRUE);
   assert(cloak_transcendence_avoids_physical_hit(100, ELE_PHYSICAL, TYPE_HIT, TRUE, 48, 3) ==
          FALSE);
   assert(cloak_transcendence_avoids_physical_hit(100, ELE_FIRE, TYPE_HIT, TRUE, 48, 0) == FALSE);
   assert(cloak_transcendence_avoids_physical_hit(100, ELE_PHYSICAL, TYPE_UNDEFINED, TRUE, 48, 0) ==
          TRUE);
   assert(cloak_transcendence_avoids_physical_hit(0, ELE_PHYSICAL, TYPE_HIT, TRUE, 48, 0) == FALSE);
   assert(cloak_transcendence_avoids_physical_hit(100, ELE_PHYSICAL, TYPE_HIT, FALSE, 48, 0) ==
          FALSE);
}
