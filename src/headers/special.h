...
DECLARE_SPEC_FUN(spec_rr_byways_warden);
DECLARE_SPEC_FUN(spec_rr_byways_hermit);
DECLARE_SPEC_FUN(spec_rr_byways_innkeeper);
DECLARE_SPEC_FUN(spec_rr_byways_ferryman);
DECLARE_SPEC_FUN(spec_rr_byways_scholar);
DECLARE_SPEC_FUN(spec_rr_byways_market);
DECLARE_SPEC_FUN(spec_rr_byways_kiess_clerk);
DECLARE_SPEC_FUN(spec_rr_byways_midgaard_guard);
DECLARE_SPEC_FUN(spec_reach_warden);
DECLARE_SPEC_FUN(spec_reach_guide);
DECLARE_SPEC_FUN(spec_reach_assessor);
DECLARE_SPEC_FUN(spec_reach_outrider);
DECLARE_SPEC_FUN(spec_reach_scavenger);
DECLARE_SPEC_FUN(spec_reach_tidewright);
DECLARE_SPEC_FUN(spec_reach_carter);
DECLARE_SPEC_FUN(spec_reach_smuggler);
